...
export default async function BlogDetailPage({ params }: Props) {
	...
	return (
		<div className="relative flex flex-col items-center min-h-[calc(100vh-4rem)] px-6 py-16 bg-background text-foreground transition-colors duration-300">
			{/* Background decorations */}
			<div className="absolute top-1/4 left-1/3 -z-10 h-75 w-75 rounded-full bg-brand-primary/5 blur-[100px]"></div>
			...
			<main className="w-full max-w-3xl mx-auto flex flex-col gap-10">
				...
				{/* Article Content */}
				<article className="prose dark:prose-invert max-w-none text-base leading-relaxed text-foreground opacity-95 whitespace-pre-wrap flex flex-col gap-6">
					{post.content}
				</article>
			</main>
		</div>
